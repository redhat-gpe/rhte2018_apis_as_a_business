...
..  *Private Base URL:* http://i-integration-$OCP_USERNAME-fuse-ignite.apps.$OCP_DOMAIN
..  *Staging URL:* https://$OCP_USERNAME-quote-stage.apps.$OCP_DOMAIN
..  *Production URL:* https://$OCP_USERNAME-quote-stage.apps.$OCP_DOMAIN
...
.. *OpenID Connect Issuer:* http://3scale-client:<your secret&gt;@$OCP_USERNAME-unsecured-sso.apps.$OCP_DOMAIN/auth/realms/3scaleRealm
...
. Correct the *host* property to match the Production URL of your API in 3scale: https://$OCP_USERNAME-quote-stage.apps.$OCP_DOMAIN
...
+
----
TKN=$(curl -X POST "http://3scale-client:<your secret&gt;@$OCP_USERNAME-unsecured-sso.apps.$OCP_DOMAIN/auth/realms/3scaleRealm/protocol/openid-connect/token" \
