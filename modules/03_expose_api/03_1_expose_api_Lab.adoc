...
..  *Production URL:* https://$OCP_USERNAME-quote-stage.$OCP_SUFFIX
...
.. *OpenID Connect Issuer:* http://3scale-client:<your secret&gt;@$OCP_USERNAME-unsecured-sso.$OCP_SUFFIX/auth/realms/3scaleRealm
...
. Correct the *host* property to match the Production URL of your API in 3scale: https://$OCP_USERNAME-quote-stage.$OCP_SUFFIX
...
+
----
TKN=$(curl -X POST "http://3scale-client:<your secret&gt;@$OCP_USERNAME-unsecured-sso.$OCP_SUFFIX/auth/realms/3scaleRealm/protocol/openid-connect/token" \
