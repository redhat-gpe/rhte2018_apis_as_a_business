...
. In a browser, try to access the URL https://$OCP_USERNAME-3scale-mt-opentlc-mgr.$OCP_SUFFIX/swagger/spec/quotes.json and ensure you can view the API doc for Quotes API.
+
