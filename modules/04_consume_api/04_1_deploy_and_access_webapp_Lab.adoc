...
. Select the project *$OCP_USERID-client*
...
|=======================
| Parameter | Value 
| *Application Hostname* | $OCP_UERID-quote-client.apps.$OCP_DOMAIN
| *Quotes API URL* | https://$OCP_USERID-3scale-mt-admin.apps.$OCP_DOMAIN/swagger/spec/quotes.json
...
. Go to http://$OCP_UERID-quote-client.apps.$OCP_DOMAIN
